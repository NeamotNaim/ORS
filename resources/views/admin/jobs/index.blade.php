...
<div class="content d-flex flex-column flex-column-fluid pt-7">
        ...
        <div class="d-md-flex">
                    ...
                    <form class="d-flex position-relative">
                        <div class="position-relative d-flex width-320">
                          <span class="position-absolute d-flex align-items-center top-0 bottom-0 left-0 text-gray-600 ms-3">
                            ...
                            <input class="form-control search-box ps-8" wire:model="table.search" type="search" placeholder="Search" aria-label="Search">
                        </div>
                    </form>
                                    </div>
            ...
            <div class="d-md-flex">
                            ...
                            <div class="dropdown d-flex align-items-center me-4 me-md-5">
                                ...
                                <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <div class="p-5">
                                                ...
                                                <select wire:model.stop="table.filters.featured_job" wire:key="table-filter-featured_job" id="table-filter-featured_job" class="form-select form-select-solid">
                    ...
                    <option value="no">No</option>
                                                ...
                                                <select wire:model.stop="table.filters.suspended_job" wire:key="table-filter-suspended_job" id="table-filter-suspended_job" class="form-select form-select-solid">
                    ...
                    <option value="0">No</option>
                                                ...
                                                <select wire:model.stop="table.filters.freelancer_job" wire:key="table-filter-freelancer_job" id="table-filter-freelancer_job" class="form-select form-select-solid">
                    <option value="">All</option>
                    <option value="1">Yes</option>
                    <option value="0">No</option>
            </select>
                                                ...
                                                <select wire:model.stop="table.filters.job_status" wire:key="table-filter-job_status" id="table-filter-job_status" class="form-select form-select-solid">
                    <option value="">All</option>
                    ...
                    <option value="expire">Expire</option>
                                            ...
                                            <button class="btn btn-secondary" wire:click.prevent="setFilterDefaults" x-on:click="open = false">Reset</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="menu-item">
    <a href="http://127.0.0.1:8080/admin/jobs/create" class="btn btn-primary">Add</a>
</div>
                            </div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            <thead class="">
                <tr>
                    <th scope="col" class="" style="width:35%" wire:key="header-col-0-58kM4BGCH9lzo0UNdGfu">
                    <div class="d-flex align-items-center" wire:click="sortBy('job_title')" style="cursor:pointer;">
                <span>Job Title</span>
                ...
                <th scope="col" class="text-center" wire:key="header-col-1-58kM4BGCH9lzo0UNdGfu">
                    Is Featured
            </th>
                                                            
                <th scope="col" class="text-center" wire:key="header-col-2-58kM4BGCH9lzo0UNdGfu">
                    Is Suspended
            </th>
                                                            
                <th scope="col" class="text-center" wire:key="header-col-3-58kM4BGCH9lzo0UNdGfu">
                    <div class="d-flex align-items-center" wire:click="sortBy('created_at')" style="cursor:pointer;">
                ...
                <th scope="col" class="text-center" wire:key="header-col-4-58kM4BGCH9lzo0UNdGfu">
                    <div class="d-flex align-items-center" wire:click="sortBy('job_expiry_date')" style="cursor:pointer;">
                ...
                <th scope="col" class="text-center" wire:key="header-col-5-58kM4BGCH9lzo0UNdGfu">
                    Last Changes By
            </th>
                                                            
                <th scope="col" class="text-center" wire:key="header-col-6-58kM4BGCH9lzo0UNdGfu">
                    Action
            </th>
                </tr>
            </thead>
            ...
            <tbody class="">
                <tr wire:loading.class.delay="" class="" wire:key="row-0-58kM4BGCH9lzo0UNdGfu">
        <td class="" wire:key="cell-0-0-58kM4BGCH9lzo0UNdGfu">
        <a class="cursor-pointer text-decoration-none" href="http://127.0.0.1:8080/admin/jobs/1">
    bal
</a>
    </td>
                                                                            
                    <td class="" wire:key="cell-0-1-58kM4BGCH9lzo0UNdGfu">
        <div class="d-flex justify-content-center">
            ...
            <ul class="fs-6 py-4 dropdown-menu customDropdown" aria-labelledby="dropdownMenuButton1">
                <li><a class="btn btn-sm adminJobMakeFeatured" data-id="1">Make Featured</a>
                </li>
            </ul>
        </div>
            </div>
    ...
    <label class="form-check form-switch form-switch-sm justify-content-center">
        <input type="checkbox" name="Is Suspended" class="form-check-input isSuspended" data-id="1">
    </label>
</div>
    </td>
    ...
    <span class="badge bg-secondary">
        ...
        <div class="d-flex justify-content-center">
    <a href="http://127.0.0.1:8080/admin/jobs/1/edit" title="Edit" class="btn px-2 text-primary fs-3 ps-0 edit-btn" data-bs-toggle="tooltip">
    ...
    <button type="button" title="Delete" data-id="1" class="delete-btn btn px-2 text-danger fs-3 pe-0" id="deleteUser" data-bs-toggle="tooltip">
        <svg class="svg-inline--fa fa-trash" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M135.2 17.69C140.6 6.848 151.7 0 163.8 0H284.2C296.3 0 307.4 6.848 312.8 17.69L320 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H128L135.2 17.69zM394.8 466.1C393.2 492.3 372.3 512 346.9 512H101.1C75.75 512 54.77 492.3 53.19 466.1L31.1 128H416L394.8 466.1z"></path></svg><!-- <i class="fa-solid fa-trash"></i> Font Awesome fontawesome.com -->
                                ...
                                <tr wire:loading.class.delay="" class="" wire:key="row-1-58kM4BGCH9lzo0UNdGfu">
        <td class="" wire:key="cell-1-0-58kM4BGCH9lzo0UNdGfu">
        <a class="cursor-pointer text-decoration-none" href="http://127.0.0.1:8080/admin/jobs/2">
    Baler job
</a>
    </td>
                                                                            
                    <td class="" wire:key="cell-1-1-58kM4BGCH9lzo0UNdGfu">
        <div class="d-flex justify-content-center">
            <div class="dropdown">
            <a class="btn btn-secondary text-white btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                Make Feature
            ...
            <ul class="fs-6 py-4 dropdown-menu customDropdown" aria-labelledby="dropdownMenuButton1">
                <li><a class="btn btn-sm adminJobMakeFeatured" data-id="2">Make Featured</a>
                </li>
            </ul>
        </div>
            </div>
                    ...
                    <td class="" wire:key="cell-1-2-58kM4BGCH9lzo0UNdGfu">
        <div class="d-flex justify-content-center">
    <label class="form-check form-switch form-switch-sm justify-content-center">
        <input type="checkbox" name="Is Suspended" class="form-check-input isSuspended" data-id="2">
    </label>
</div>
    </td>
                                                                            
                    <td class="" wire:key="cell-1-3-58kM4BGCH9lzo0UNdGfu">
        <div class="d-flex">
    <span class="badge bg-secondary">
        9th Jan, 2023
    </span>
                    ...
                    <td class="" wire:key="cell-1-4-58kM4BGCH9lzo0UNdGfu">
        <div class="d-flex">
            ...
            21st Jan, 2023
                    ...
                    <td class="" wire:key="cell-1-5-58kM4BGCH9lzo0UNdGfu">
        <span class="badge bg-secondary">N/A</span>
    </td>
                                                                            
                    <td class="text-center" width="15%" wire:key="cell-1-6-58kM4BGCH9lzo0UNdGfu">
        <div class="d-flex justify-content-center">
    <a href="http://127.0.0.1:8080/admin/jobs/2/edit" title="Edit" class="btn px-2 text-primary fs-3 ps-0 edit-btn" data-bs-toggle="tooltip">
        <svg class="svg-inline--fa fa-pen-to-square" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-to-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M490.3 40.4C512.2 62.27 512.2 97.73 490.3 119.6L460.3 149.7L362.3 51.72L392.4 21.66C414.3-.2135 449.7-.2135 471.6 21.66L490.3 40.4zM172.4 241.7L339.7 74.34L437.7 172.3L270.3 339.6C264.2 345.8 256.7 350.4 248.4 353.2L159.6 382.8C150.1 385.6 141.5 383.4 135 376.1C128.6 370.5 126.4 361 129.2 352.4L158.8 263.6C161.6 255.3 166.2 247.8 172.4 241.7V241.7zM192 63.1C209.7 63.1 224 78.33 224 95.1C224 113.7 209.7 127.1 192 127.1H96C78.33 127.1 64 142.3 64 159.1V416C64 433.7 78.33 448 96 448H352C369.7 448 384 433.7 384 416V319.1C384 302.3 398.3 287.1 416 287.1C433.7 287.1 448 302.3 448 319.1V416C448 469 405 512 352 512H96C42.98 512 0 469 0 416V159.1C0 106.1 42.98 63.1 96 63.1H192z"></path></svg><!-- <i class="fa-solid fa-pen-to-square"></i> Font Awesome fontawesome.com -->
    </a>
    <button type="button" title="Delete" data-id="2" class="delete-btn btn px-2 text-danger fs-3 pe-0" id="deleteUser" data-bs-toggle="tooltip">
        <svg class="svg-inline--fa fa-trash" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M135.2 17.69C140.6 6.848 151.7 0 163.8 0H284.2C296.3 0 307.4 6.848 312.8 17.69L320 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H128L135.2 17.69zM394.8 466.1C393.2 492.3 372.3 512 346.9 512H101.1C75.75 512 54.77 492.3 53.19 466.1L31.1 128H416L394.8 466.1z"></path></svg><!-- <i class="fa-solid fa-trash"></i> Font Awesome fontawesome.com -->
    </button>
</div>
    </td>
...
<!-- Livewire Component wire-end:58kM4BGCH9lzo0UNdGfu -->        </div>
    </div>
                </div>
            </div>
